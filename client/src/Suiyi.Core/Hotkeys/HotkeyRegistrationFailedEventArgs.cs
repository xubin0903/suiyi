...
public sealed class HotkeyRegistrationFailedEventArgs(string hotkey, string reason, bool invalidFormat, string label = "快捷键") : EventArgs
{
    ...
    /// <summary>名称，例如「快捷键」「框选快捷键」。</summary>
    public string Label { get; } = label;

    /// <summary>面向用户的提示，例如「快捷键 Ctrl+Alt+T 已被其他程序占用，请在设置中修改」。</summary>
    public string Message => $"{Label} {Hotkey} {Reason}，请在设置中修改";
}
